...
complete -c monerod -l p2p-bind-port -r -d "Port for p2p network protocol (IPv4). Default: 21090, 31090 if 'testnet', 41090 if 'stagenet'"
complete -c monerod -l p2p-bind-port-ipv6 -d "Port for p2p network protocol (IPv6). Default: 21090, 31090 if 'testnet', 41090 if 'stagenet'"
...
complete -c monerod -l rpc-bind-port -r -d "Port for RPC server. Default: 21091, 31091 if 'testnet', 41091 if 'stagenet'"
